      ...
      <section className="section dark">
        <div className="container" style={{display: 'grid', gridTemplateColumns: '1.4fr 0.8fr', gap: '28px', alignItems: 'start'}}>
          <div>
            ...
            <div style={{height: '360px', borderRadius: '26px', backgroundImage: `linear-gradient(to top, rgba(0,0,0,0.45), rgba(0,0,0,0.05)), url(${trip.photo})`, backgroundSize: 'cover', backgroundPosition: 'center', marginBottom: '22px'}}></div>
