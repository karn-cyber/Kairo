      ...
      <section className="section cream">
        <div className="container">
          ...
          <div style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', marginBottom: '44px'}}>
            {[
              {title: 'Himalayan Circuit', subtreks: 3, days: '21', rating: '4.9'},
              {title: 'Spiti Valley Explorer', subtreks: 2, days: '14', rating: '4.8'},
              {title: 'Northeast Adventure', subtreks: 4, days: '28', rating: '4.7'}
            ].map((guide, i) => (
              <Card key={i} style={{overflow: 'hidden', borderRadius: '16px', cursor: 'pointer', transition: 'transform 0.3s'}}>
                <div style={{
                  height: '180px',
                  background: i === 0 ? 'linear-gradient(135deg,#1C2E18,#2A4428)' : i === 1 ? 'linear-gradient(135deg,#1A2C3E,#2A4050)' : 'linear-gradient(135deg,#2A1E10,#3A2C18)',
                  position: 'relative',
                  display: 'flex',
                  alignItems: 'flex-end',
                  padding: '16px'
