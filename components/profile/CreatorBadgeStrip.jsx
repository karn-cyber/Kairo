...
export default function CreatorBadgeStrip({ profile, onBookClick }) {
  ...
  return (
    <div style={{ maxWidth: 935, margin: '0 auto', padding: '16px 16px', background: 'var(--og)', borderRadius: 12, marginTop: 12, border: '1px solid rgba(200,90,26,0.16)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, flex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <MapPin size={16} color="var(--orange)" strokeWidth={1.5} />
            <span style={{ fontSize: 13, fontWeight: 600 }}>{profile.creatorStats.tripsPublished} trips</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <Star size={16} color="var(--orange)" strokeWidth={1.5} />
            <span style={{ fontSize: 13, fontWeight: 600 }}>{profile.creatorStats.avgRating} rating</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <Users size={16} color="var(--orange)" strokeWidth={1.5} />
